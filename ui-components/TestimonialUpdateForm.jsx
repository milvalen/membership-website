...
import { getTestimonial } from "../src/graphql/queries";
import { updateTestimonial } from "../src/graphql/mutations";
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getTestimonial.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getTestimonial
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateTestimonial.replaceAll("__typename", ""),
            variables: {
              input: {
                id: testimonialRecord.id,
                ...modelFields,
              },
            },
          });
